...
func (x *AdjustStockRequest) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
const file_proto_product_proto_rawDesc = "" +
	"\n" +
	"\x13proto/product.proto\x12\aproduct\"\x95\x01\n" +
	...
	"\x05price\x18\x04 \x01(\x01R\x05price\x12\x14\n" +
	"\x05stock\x18\x05 \x01(\x05R\x05stock\x12\x1b\n" +
	"\timage_url\x18\x06 \x01(\tR\bimageUrl2\xde\x03\n" +
	...
	"\rUpdateProduct\x12\x1d.product.UpdateProductRequest\x1a\x1e.product.UpdateProductResponse\x12H\n" +
	"\vAdjustStock\x12\x1b.product.AdjustStockRequest\x1a\x1c.product.AdjustStockResponse\x12N\n" +
...
var file_proto_product_proto_goTypes = []any{
	...
	(*AdjustStockRequest)(nil),    // 6: product.AdjustStockRequest
	(*AdjustStockResponse)(nil),   // 7: product.AdjustStockResponse
...
var file_proto_product_proto_depIdxs = []int32{
	...
	6,  // 4: product.ProductService.AdjustStock:input_type -> product.AdjustStockRequest
	8,  // 5: product.ProductService.DeleteProduct:input_type -> product.DeleteProductRequest
	10, // 6: product.ProductService.ListProducts:input_type -> product.ListProductsRequest
	...
	7,  // 10: product.ProductService.AdjustStock:output_type -> product.AdjustStockResponse
	9,  // 11: product.ProductService.DeleteProduct:output_type -> product.DeleteProductResponse
	11, // 12: product.ProductService.ListProducts:output_type -> product.ListProductsResponse
